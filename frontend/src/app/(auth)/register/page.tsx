...
export default function RegisterPage() {
  ...
  return (
    <div className="brutalist-card p-8 animate-brutalist-in">
      ...
      <p className="text-sm text-gray-500 font-mono mb-6">Join the defense force</p>
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        ...
        <Link href="/login" className="font-bold text-black underline decoration-[3px] decoration-black underline-offset-4 hover:bg-black hover:text-cream px-1 transition-colors">
          Sign in
        </Link>
      </p>
    </div>
